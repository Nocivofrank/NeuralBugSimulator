...
class Bug():
    ...
    mouse_direction = pygame.Vector2(0,0)
    ...
    def mouse_stat_pos(pos, mouse_direction , s):
        Bug.mouse_pos = pos
        Bug.scroll_wheel_range = s

    def thinkFoward(self):
        self.brain.information[0] = Bug.mouse_pos.distance_to(self.pos) / 100
        self.brain.information[1] = self.direction[0] / 100
        self.brain.information[2] = self.direction[1] / 100
        self.brain.information[3] = self.speed / 100
        self.brain.information[9] = Bug.mouse_direction[0] / 100
        self.brain.information[10] = Bug.mouse_direction[1] / 100
        self.brain.information[11] = self.vel[0] / 100
        self.brain.information[12] = self.vel[1] / 100
        # self.brain.information[13] = self.time_alive
        self.brain.information[14] = Bug.mouse_pos[0] / 100
        self.brain.information[15] = Bug.mouse_pos[1] / 100
